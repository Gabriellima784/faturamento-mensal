const faturamentoDiarioJSON = [
  ...
  console.log('Menor valor de faturamento diário:', calcularMenorFaturamentoDiario(faturamentoDiario));
  console.log('Maior valor de faturamento diário:', calcularMaiorFaturamentoDiario(faturamentoDiario));
  console.log('Número de dias com faturamento acima da média mensal:', calcularDiasAcimaMediaMensal(faturamentoDiario));
